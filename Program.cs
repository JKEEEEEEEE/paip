...
try
{
	...
	builder.Services.AddDbContext<kursach_diplom_api.Models.KurcachDiplomContext>(option => option.UseSqlServer(builder.Configuration.GetConnectionString("Connection")));
